...
const ITEMS = [
  ...
  {id:'cap',name:'Gorra de festa',icon:'🧢',slot:'head',cost:90,currency:'cigs',appearsAt:180,perk:'+1 Carisma en trobades · +5% crític a la ronda',stats:{charisma:1},combat:{crit:.05},description:'Va sobreviure a nits que no haurien d’haver passat.'},
